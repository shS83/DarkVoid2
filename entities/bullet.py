...
class EnemyBullet(pg.sprite.Sprite):
    def __init__(self, game, pos, velocity):
        ...
        pg.draw.circle(self.image, (128, 0, 50), center, self.radius)
        pg.draw.circle(self.image, (255, 0, 30), center, self.radius - 6)
        pg.draw.circle(self.image, (255, 0, 0), center, self.radius - 10)
        pg.draw.circle(self.image, (255, 80, 80), center, self.radius - 14)
